...
#
# Script generated by Vivado on Tue Apr 22 10:54:57 WEST 2025
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/viny/Desktop/interrupt_control/8051-Pipeline/pipelinedV1/pipelinedV1.cache/compile_simlib/xcelium"
  fi
