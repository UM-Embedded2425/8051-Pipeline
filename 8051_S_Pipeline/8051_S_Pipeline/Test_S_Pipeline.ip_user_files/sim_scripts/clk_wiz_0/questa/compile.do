...
vlog -work xpm -64 -incr -mfcu  -sv "+incdir+../../../ipstatic" "+incdir+../../../../PLLtest.gen/sources_1/ip/clk_wiz_0" \
...
vlog -work xil_defaultlib -64 -incr -mfcu  "+incdir+../../../ipstatic" "+incdir+../../../../PLLtest.gen/sources_1/ip/clk_wiz_0" \
