...
`define ADD_I     8'b0010_011x // add A=A+@Ri                 //TESTADO
`define ADD_R     8'b0010_1xxx // add A=A+Rx                  //TESTADO

`define ADDC_C    8'b0011_0100 // add A=A+constant+c          //TESTADO
`define ADDC_D    8'b0011_0101 // add A=A+(direct)+c          //TESTADO
`define ADDC_I    8'b0011_011x // add A=A+@Ri+c               //TESTADO
`define ADDC_R    8'b0011_1xxx // add A=A+Rx+c                //TESTADO
...
`define DEC_A     8'b0001_0100 // decrement accumulator a=a-1                      //TESTADO
`define DEC_D     8'b0001_0101 // decrement direct (direct)=(direct)-1             //TESTADO
`define DEC_I     8'b0001_011x // decrement indirect @Ri=@Ri-1
`define DEC_R     8'b0001_1xxx // decrement reg Rn=Rn-1                            //TESTADO
...
`define INC_A     8'b0000_0100 // increment accumulator                            //TESTADO
`define INC_D     8'b0000_0101 // increment (direct)                               //TESTADO
`define INC_DP    8'b1010_0011 // increment data pointer                          //TESTADO
`define INC_I     8'b0000_011x // increment @Ri 
`define INC_R     8'b0000_1xxx // increment Rn                                    //TESTADO
...
`define LJMP      8'b0000_0010 // long jump                   //TESTADO         

`define MOV_AD    8'b1111_0101 // move (direct)=A             //TESTADO         //hF5
`define MOV_AI    8'b1111_011x // move @Ri=A                  //TESTADO
`define MOV_AR    8'b1111_1xxx // move Rn=A                   //TESTADO 
`define MOV_BC    8'b1010_0010 // move c=bit                  //TESTADO
`define MOV_CB    8'b1001_0010 // move bit=c                  //TESTADO
`define MOV_C     8'b0111_0100 // move A=constant             //TESTADO
`define MOV_CD    8'b0111_0101 // move (direct)=constant      //TESTADO
`define MOV_CI    8'b0111_011x // move @Ri=constant           //TESTADO
`define MOV_CR    8'b0111_1xxx // move Rn=constant            //TESTADO
`define MOV_D     8'b1110_0101 // move A=(direct)             //TESTADO         //hE5
`define MOV_DD    8'b1000_0101 // move (direct)=(direct)      //TESTADO
`define MOV_DI    8'b1010_011x // move @Ri=(direct)           //TESTADO
`define MOV_DR    8'b1010_1xxx // move Rn=(direct)            //TESTADO
`define MOV_DP    8'b1001_0000 // move dptr=constant(16 bit)  //TESTADO
`define MOV_I     8'b1110_011x // move A=@Ri                  //TESTADO
`define MOV_ID    8'b1000_011x // move (direct)=@Ri           //TESTADO
`define MOV_R     8'b1110_1xxx // move A=Rn                   //TESTADO
`define MOV_RD    8'b1000_1xxx // move (direct)=Rn            //TESTADO
`define MOVC_DP   8'b1001_0011 // move A=dptr+A               //TESTADO
`define MOVC_PC   8'b1000_0011 // move A=pc+A                 //TESTADO

`define MOVX_AI   8'b1111_001x // move (@Ri)=A                //TESTADO 
`define MOV_SFR   8'b1111_0000                                //TESTADO (for SFR)  ANTES (MOVX_AP  // move (dptr)=A)
`define MOVX_IA   8'b1110_001x // move A=(@Ri)                //TESTADO
`define MOVX_PA   8'b1110_0000 // move A=(dptr)               //TESTADO
...
//_________________________________________ALU___________________________________________________

 `define OP_ADD 5'b00000
 `define OP_ADDC 5'b00001
 `define OP_SUBB 5'b00010
 `define OP_INC 5'b00011
 `define OP_DEC 5'b00101
 `define OP_MUL 5'b00110
 `define OP_DIV 5'b00111
 `define OP_DA 5'b01000
 `define OP_ANL 5'b01001
 `define OP_ANL_BIT 5'b01010
 `define OP_ORL 5'b01011
 `define OP_ORL_BIT 5'b01100
 `define OP_XRL 5'b01101
 `define OP_CLR 5'b01110
 `define OP_CLR_CY 5'b01111
 `define OP_CPL 5'b10000
 `define OP_CPL_CY 5'b10001
 `define OP_RL 5'b10010
 `define OP_RLC 5'b10011
 `define OP_RR 5'b10100
 `define OP_RRC 5'b10101
