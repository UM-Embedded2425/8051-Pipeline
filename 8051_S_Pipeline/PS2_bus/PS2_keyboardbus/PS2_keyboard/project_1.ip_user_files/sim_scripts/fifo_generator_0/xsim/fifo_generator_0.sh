...
#
# Script generated by Vivado on Tue May 20 13:22:00 WEST 2025
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L fifo_generator_v13_2_11 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fifo_generator_0 xil_defaultlib.fifo_generator_0 xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/tools/Vivado/2024.2/data/xsim"
  fi
