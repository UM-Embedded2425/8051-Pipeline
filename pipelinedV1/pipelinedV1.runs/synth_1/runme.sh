...
HD_PWD='/home/viny/Desktop/interrupt_control/8051-Pipeline/pipelinedV1/pipelinedV1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU8051.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CPU8051.tcl
