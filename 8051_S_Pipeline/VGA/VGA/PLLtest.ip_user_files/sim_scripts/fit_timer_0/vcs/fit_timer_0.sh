...
design_libs=(xilinx_vip xpm fit_timer_v2_0_12 xil_defaultlib)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fit_timer_0 xil_defaultlib.glbl -o fit_timer_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fit_timer_0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key fit_timer_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fit_timer_0_simv.daidir vcs_lib c.obj)
