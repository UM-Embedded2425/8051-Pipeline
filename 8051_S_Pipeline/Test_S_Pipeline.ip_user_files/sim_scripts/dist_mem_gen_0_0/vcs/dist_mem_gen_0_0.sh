...
#
# Script generated by Vivado on Tue Jun 10 19:49:06 WEST 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : dist_mem_gen_0_0.sh
...
#
# Usage        : dist_mem_gen_0_0.sh
#                dist_mem_gen_0_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dist_mem_gen_0_0.sh [-reset_run]
#                dist_mem_gen_0_0.sh [-reset_log]
#                dist_mem_gen_0_0.sh [-help]
#
...
#                script (type 'dist_mem_gen_0_0.sh -help' for more information).
#
...
# script info
echo -e "dist_mem_gen_0_0.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dist_mem_gen_0_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.dist_mem_gen_0_0 xil_defaultlib.glbl -o dist_mem_gen_0_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./dist_mem_gen_0_0_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/telmo/Desktop/Vivado/8051/8051_S_Pipeline/Test_S_Pipeline.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key dist_mem_gen_0_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc dist_mem_gen_0_0_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./dist_mem_gen_0_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: dist_mem_gen_0_0.sh [-help]\n\
Usage: dist_mem_gen_0_0.sh [-step]\n\
Usage: dist_mem_gen_0_0.sh [-lib_map_path]\n\
Usage: dist_mem_gen_0_0.sh [-reset_run]\n\
Usage: dist_mem_gen_0_0.sh [-reset_log]\n\
Usage: dist_mem_gen_0_0.sh [-keep_index]\n\
Usage: dist_mem_gen_0_0.sh [-noclean_files]\n\n\
