...
HD_PWD='/home/user/Documents/Embedded/VGA/VGA/PLLtest.runs/fit_timer_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fit_timer_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fit_timer_0.tcl
