...
HD_PWD='/home/viny/Desktop/interrupt_control/8051-Pipeline/pipelinedV1/pipelinedV1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU8051.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CPU8051.tcl -notrace
