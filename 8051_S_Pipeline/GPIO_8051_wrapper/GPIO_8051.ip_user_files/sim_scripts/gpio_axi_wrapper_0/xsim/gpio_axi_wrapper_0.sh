...
#
# Script generated by Vivado on Tue Apr 22 11:40:46 WEST 2025
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : gpio_axi_wrapper_0.sh
...
#
# Usage        : gpio_axi_wrapper_0.sh
#                gpio_axi_wrapper_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                gpio_axi_wrapper_0.sh [-reset_run]
#                gpio_axi_wrapper_0.sh [-reset_log]
#                gpio_axi_wrapper_0.sh [-help]
#
...
# script info
echo -e "gpio_axi_wrapper_0.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./gpio_axi_wrapper_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot gpio_axi_wrapper_0 xil_defaultlib.gpio_axi_wrapper_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim gpio_axi_wrapper_0 -key {Behavioral:sim_1:Functional:gpio_axi_wrapper_0} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/luisbatista/Xilinx/Vivado/2024.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb gpio_axi_wrapper_0.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./gpio_axi_wrapper_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: gpio_axi_wrapper_0.sh [-help]\n\
Usage: gpio_axi_wrapper_0.sh [-step]\n\
Usage: gpio_axi_wrapper_0.sh [-lib_map_path]\n\
Usage: gpio_axi_wrapper_0.sh [-reset_run]\n\
Usage: gpio_axi_wrapper_0.sh [-reset_log]\n\
Usage: gpio_axi_wrapper_0.sh [-keep_index]\n\
Usage: gpio_axi_wrapper_0.sh [-noclean_files]\n\n\
