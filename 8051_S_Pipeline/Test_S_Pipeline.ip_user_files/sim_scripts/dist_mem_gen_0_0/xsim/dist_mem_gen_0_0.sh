...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L dist_mem_gen_v8_0_15 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot dist_mem_gen_0_0 xil_defaultlib.dist_mem_gen_0_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim dist_mem_gen_0_0 -key {Behavioral:sim_1:Functional:dist_mem_gen_0_0} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb dist_mem_gen_0_0.wdb xsim.dir libdpi.so)
