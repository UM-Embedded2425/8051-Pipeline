...
#
# Script generated by Vivado on Tue Jun 10 14:52:54 WEST 2025
...
# script info
echo -e "dist_mem_gen_1.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L dist_mem_gen_v8_0_15 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot dist_mem_gen_1 xil_defaultlib.dist_mem_gen_1 xil_defaultlib.glbl -log elaborate.log
}
