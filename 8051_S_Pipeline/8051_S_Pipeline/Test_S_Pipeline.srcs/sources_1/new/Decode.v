...
`include "defines.v"
    ...
    module decode(
        ...
        output wire [7:0] reg_read, sfr_out,  ACC, SP, DPL, DPH, B, PSW, P0, P1, P2, P3, TMOD, TCON, TH0, TL0, TH1, TL1, IE, IP, SCON, SBUF, 
    ...
    always @(posedge clk or posedge reset)begin
        if(reset)begin 
            ...
            if (IR1[15:8] == VGA_CONF_ADDR || IR1[15:8] == VGA_DATA_ADDR || IR1[15:8] == VGA_ADDR_H_ADDR || IR1[15:8] == VGA_ADDR_L_ADDR ||
                ...
                IR1[15:8] == TCON_ADDR || IR1[15:8] == TMOD_ADDR || IR1[15:8] == TH0_ADDR || IR1[15:8] == TL0_ADDR || IR1[15:8] == PS2_SBUF_ADDR ||
